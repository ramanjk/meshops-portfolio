...
(UC-03 / MLOps). Same discipline as iteration-01 — zero writes, no HITL — pointed
at a new substrate.
...
| [`02_implementation_guide.md`](02_implementation_guide.md) | How it's built — module, `mlflow-mcp` shim, prompts, chart, MLflow substrate. Calls out only what differs from iter-01. |
...
| Inference (iter-01) | `http://104.44.182.236:8080/` | KAITO Workspace — replicas & GPU |
