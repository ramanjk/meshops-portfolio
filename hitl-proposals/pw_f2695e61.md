# HITL write proposal `pw_f2695e61`

**Intent:** promote phi-4-mini-meshops v3 → Production

**Rationale:** Promoting v3 from Staging to Production as requested; v3 currently in Staging with higher eval_accuracy (0.86) than Production v2.
